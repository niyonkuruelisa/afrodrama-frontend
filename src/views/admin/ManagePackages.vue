            ...
            <div class="col-lg-6">
              ...
              <div class="col-lg-12">
                <div  class="main-title float-center center-section">
                  <button v-on:click="showAddPackageSection()" class="btn btn-secondary pl-4 pt-1 mb-2">Add New Package</button> &nbsp; &nbsp;
                </div>
          ...
          <div class="video-block section-padding">
            <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="custom-select" id="package_type" v-model="package_type">
                        ...
                        <option value="Quarter">6 Months</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-lg-12 text-center">
                    ...
                    <div v-else class="main-title float-center center-section">
                      ...
                      <button v-on:click="editPackage()" class="btn btn-primary pl-4 pt-1 mb-2">Save</button> &nbsp;
                      <button v-on:click="deletePackage(pack)" class="btn btn-danger pl-4 pt-1 mb-2">Delete Package</button> &nbsp; &nbsp;
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-12">
                ...
                <div class="row">
                  <div  class="col-xl-3 col-sm-3 mb-3" v-for="(pack,index) in packages" :key="index">
                    <div class="card text-white bg-primary o-hidden h-100 border-none" >
                      <div class="card-body">
                        <div class="card-body-icon">
  ...
  export default {
    ...
    methods: {
      ...
      async addPackage(){
        ...
        if(pack.package.name === ""){
          ...
          await axios.post('packages',pack).then( res => {
            ...
            if(err.response.data.package_type){
              alert(err.response.data.package_type)
            }
          })
        }
      ...
      async deletePackage(pack){
        console.log("Deleting...",pack.name)
        await axios.delete('packages',pack).then( res => {
          this.edit = !this.edit
          this.getPackages()
        }).catch( err => {
          console.log(err)
